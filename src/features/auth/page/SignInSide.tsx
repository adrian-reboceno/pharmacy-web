// src/features/auth/pages/SignInSide.tsx
...
import ColorModeSelect from '@/features/shared-theme/ColorModeSelect';
...
export default function SignInPage(props: { disableCustomTheme?: boolean }) {
  ...
  if (loading) {
    // Mostrar spinner mientras carga desde localStorage
    return (
      <Box
        sx={{
          display: "flex",
